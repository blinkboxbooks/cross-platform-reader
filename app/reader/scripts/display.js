...
var Reader = (function (r) {
	...
	r.init = function(param) {
		...
		r.$iframe = $(param.cprframe).appendTo(r.$parent);
		r.$cprframe = param.cprframe;
		r.$document = $(param.cprframe.$.body).contents();
		r.$head = $(r.$iframe[0].$.head);
		r.$wrap = $(r.$iframe[0].$.body);
		...
		r.Touch.init($(r.$iframe[0].shadowRoot));
	...
	function _createContainer() {
		...
		var $doc = $(r.$cprframe.$.body).contents();
