...
var Reader = (function (r) {
	...
	var _addPublisherStyles = function($head){
		...
		return $.when.apply($, links).then(function(){
			...
			// todo maybe there is a better way? we could re-create a new style element
			for( i = 0, l = r.$stylesheet[0].sheet.cssRules.length; i < l; i++){
				r.$stylesheet[0].sheet.deleteRule(0);
			}

			// append whitelisted properties
			var sheet = r.$stylesheet[0].sheet, whitelist = {
