...
var READER = (function() {
	...
	return {
		...
		setHighlight: statusWrap(Reader.Highlights.setHighlight, 'setHighlight'),
		setHighlights: statusWrap(Reader.Highlights.setHighlights, 'setHighlights'),
		removeHighlight: statusWrap(Reader.Highlights.removeHighlight, 'removeHighlight'),
